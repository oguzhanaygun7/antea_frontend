$("document").ready(function ($) {
    ...
    function mobileAccardionMenu() {
        if ($(window).innerWidth() < 1200) {
            $(".navbar__menu-link1").on("click", function (event) {
    ...
    if ($(".department-accardion").length) {
        $(".department-accardion")
            ...
            .on("click",function () {
                ...
                $(this).css("border-color", "#d51d48").find(".item-text").slideDown();
            });
    }
    ...
    $("#popup-form-open1").on("click", function (event) {
      event.preventDefault();
      $(".popup-form").css({
          opacity: "1",
          top: "0",
    ...
    function initComparisons() {
        ...
        function compareImages(img) {
            ...
            window.addEventListener("onClick", slideFinish);
    ...
    if ($(".faqs__cards").length) {
        $(".faqs__cards")
            ...
            .on("click", function () {
                ...
                $(this).css("border-color", "#d51d48").find(".faqs__cards-item-text").slideDown();
            });
    }
